...
from retail_api.cart.models import CartItem  # noqa: F401 - register with Base
from retail_api.order.models import Order, OrderItem  # noqa: F401 - register with Base
